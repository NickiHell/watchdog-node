...
from watchdog_common.diagnostics import DiagnosticPublisher, HealthStatus
...
class ExampleNode(Node):
    ...
    def __init__(self):
        ...
        self.diag = DiagnosticPublisher(self, hardware_id="watchdog_drone")
        ...
        self.pixhawk_monitor = self.diag.register_monitor("pixhawk", timeout=3.0)
