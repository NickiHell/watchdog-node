...
Общие утилиты для всех пакетов WatchDog Drone.
...
# В узле
diag = DiagnosticPublisher(self, hardware_id='watchdog_drone')
...
config = ConfigValidator.load_and_validate('config/drone_config.yaml')
